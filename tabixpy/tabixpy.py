...
from ._consts     import BLOCK_SIZE, GZIP_MAGIC
from ._gzip       import readGzipHeader, openGzipStream, getBlock, EOF
from ._io         import getFilenames, genStructValueGetter, load, save
